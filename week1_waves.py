...
class WaveIntroduction_p1(Scene):
    def construct(self):
        ...
        title = Text("What Is a Wave?  (Bennett Section 1.1)", font_size=38, color=GOLD)
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("A wave propagates energy without transporting matter", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
...
class WaveIntroduction_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Ocean: water stays put, disturbance moves — same principle", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveIntroduction_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Sound: air molecules oscillate, compression wave propagates", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveIntroduction_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("EM waves: E and B fields oscillate — no medium needed", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveIntroduction_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("1D wave equation captures all essential wave physics", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveIntroduction_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Wave function psi(x,t): physical quantity at position x, time t", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2\Psi}{\partial x^2}=\frac{1}{v^2}\frac{\partial^2\Psi}{\partial t^2}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("The 1D wave equation  (Bennett Eq. 1.1)", font_size=24, color=WAVE_COLOR)
...
class WaveEquation1D_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2\Psi}{\partial x^2}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("LEFT SIDE — spatial curvature of the wave profile", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{1}{v^2}\frac{\partial^2\Psi}{\partial t^2}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("RIGHT SIDE — temporal acceleration / v²", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Curvature in space proportional to acceleration in time", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Linear equation — superposition principle holds exactly", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\Psi = f(x-vt)\;\text{or}\;g(x+vt)", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("General solution: any shape, speed v, either direction", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p7(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("f(x-vt) moves right rigidly at speed v", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveEquation1D_p8(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Shape preservation holds only in non-dispersive media", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class WaveEquationProof_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\Psi=(x-vt)^2\quad\text{— test this in the wave equation}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Choose the quadratic as a concrete test function", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquationProof_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2\Psi}{\partial x^2}=2 \qquad \frac{\partial^2\Psi}{\partial t^2}=2v^2", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Both second derivatives computed explicitly", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquationProof_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{2}{v^2\cdot 2}=\frac{1}{v^2}\;\checkmark", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Ratio gives 1/v² — wave equation satisfied", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquationProof_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2 f}{\partial x^2}=f^{\prime\prime}\qquad\frac{\partial^2 f}{\partial t^2}=v^2 f^{\prime\prime}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("General proof for any f(x-vt) via chain rule", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class WaveEquationProof_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Any twice-differentiable function is a valid wave solution", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Harmonic wave: single-frequency sinusoidal oscillation", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\Psi(x,t)=A\sin(kx-\omega t+\phi)", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("The harmonic traveling wave  (Bennett Eq. 1.14)", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Every symbol in this equation recurs throughout the course", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"A", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("AMPLITUDE — maximum value  [V/m for E-field]  |  I ∝ A²", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"k=\frac{2\pi}{\lambda}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("WAVE NUMBER — spatial frequency  [rad/m]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\omega=2\pi f=\frac{2\pi}{T}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("ANGULAR FREQUENCY  [rad/s]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p7(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\lambda", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("WAVELENGTH — distance between adjacent crests  [m]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p8(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"f=\frac{1}{T}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("FREQUENCY — cycles per second  [Hz]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p9(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v=\frac{\omega}{k}=f\lambda", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("PHASE SPEED — speed of crests  [m/s]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p10(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\phi", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("INITIAL PHASE — shifts wave in time  [rad]", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p11(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v=f\lambda \quad k=\frac{2\pi}{\lambda} \quad \omega=2\pi f \quad T=\frac{1}{f}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("FIVE KEY RELATIONS — memorise all of them", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p12(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Worked example: lambda = 500 nm visible light in vacuum", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p13(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"k=1.257\times10^7\,\mathrm{rad/m} \qquad f=5.996\times10^{14}\,\mathrm{Hz}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Wave number and frequency for 500 nm", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p14(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\omega=3.768\times10^{15}\,\mathrm{rad/s} \qquad T=1.668\,\mathrm{fs}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Period = 1.668 femtoseconds", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p15(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("T = 1.668 fs: a million times shorter than a nanosecond", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p16(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\Psi=E_0\sin(1.257\times10^7 x-3.768\times10^{15}t+\phi)", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Complete wave function for 500 nm E-field", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWave_p17(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Any wave decomposes into harmonic components — Fourier", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\lambda=632.8\,\mathrm{nm} \quad v=c=2.998\times10^8\,\mathrm{m/s}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("He-Ne laser — given quantities", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"k=9.926\times10^6\,\mathrm{rad/m} \quad f=4.738\times10^{14}\,\mathrm{Hz}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Wave number and frequency", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\omega=2.977\times10^{15}\,\mathrm{rad/s} \quad T=2.11\,\mathrm{fs}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Angular frequency and period", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"E_x=E_0\sin(9.926\times10^6\,z-2.977\times10^{15}\,t)", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Complete E-field wave function", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("2.11 fs period: one million times shorter than a nanosecond", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("632.8 nm is about 1/100 the diameter of a human hair", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p7(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"I=\tfrac{1}{2}\varepsilon_0 c E_0^2=1327\,\mathrm{W/m^2}\;\text{for }E_0=1000\,\mathrm{V/m}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Irradiance from amplitude  (Bennett Eq. 2.33)", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p8(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("I proportional to A squared — doubling field quadruples intensity", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p9(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Optical period too short for any electronic detection", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class HarmonicWaveExample_p10(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("All optical detectors measure intensity, not field phase", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Superposition principle  (Bennett Section 1.5)", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2(\Psi_1+\Psi_2)}{\partial x^2}=\frac{1}{v^2}\frac{\partial^2(\Psi_1+\Psi_2)}{\partial t^2}\;\checkmark", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Proof: sum of solutions satisfies wave equation", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Any linear combination a psi-1 + b psi-2 is also a solution", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Two laser beams cross in space without affecting each other", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Foundation of ALL interference and diffraction  (Weeks 6-7)", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class SuperpositionPrinciple_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Fails at high intensity in nonlinear media — frequency doubling", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Two distinct velocities associated with any dispersive wave", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v_p=\frac{\omega}{k}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("PHASE VELOCITY — speed of individual crests", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v_g=\frac{d\omega}{dk}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("GROUP VELOCITY — speed of energy and information", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Vacuum: omega = ck, so vp = vg = c — no dispersion", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v_g=\frac{c}{n+\omega\,dn/d\omega}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Group velocity in dispersive medium  (Bennett 7.7)", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Normal dispersion: dn/d-omega > 0 so vg < c/n — energy slower than crests", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class PhaseGroupVelocity_p7(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\omega=ak^2 \;\Rightarrow\; v_p=ak,\quad v_g=2ak=2v_p", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Dispersive example: group speed = 2 x phase speed", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Complex notation replaces trig with exponentials  (Bennett 1.6)", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"e^{i\theta}=\cos\theta+i\sin\theta", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Euler's formula — foundation of complex wave notation", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\cos\theta=\mathrm{Re}[e^{i\theta}] \qquad \sin\theta=\mathrm{Im}[e^{i\theta}]", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Cosine = real part, sine = imaginary part", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}=Ae^{i(kx-\omega t)} \quad \Psi_\mathrm{phys}=\mathrm{Re}[\tilde{\Psi}]", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Complex wave — physical wave is real part", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"|\tilde{\Psi}|^2=\tilde{\Psi}\cdot\tilde{\Psi}^*=A^2", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Intensity proportional to modulus squared = A squared", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p6(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"|\tilde{\Psi}_1+\tilde{\Psi}_2|^2=A_1^2+A_2^2+2\mathrm{Re}[\tilde{\Psi}_1\tilde{\Psi}_2^*]", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Cross term = interference term", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p7(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}_{3D}=Ae^{i(\mathbf{k}\cdot\mathbf{r}-\omega t)}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("3D plane wave — wavefronts perpendicular to k", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p8(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}_\mathrm{sph}=\frac{A}{r}e^{i(kr-\omega t)}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Spherical wave — amplitude 1/r, intensity 1/r squared", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ComplexRepresentation_p9(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Inverse square law follows from energy conservation", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class ThreeDWaves_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\nabla^2\Psi=\frac{1}{v^2}\frac{\partial^2\Psi}{\partial t^2}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("3D wave equation  (Bennett Section 1.7)", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ThreeDWaves_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}=Ae^{i(\mathbf{k}\cdot\mathbf{r}-\omega t)} \quad |\mathbf{k}|=\frac{2\pi}{\lambda}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("3D plane wave — k-vector in propagation direction", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ThreeDWaves_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}=\frac{A}{r}e^{i(kr-\omega t)} \quad I\propto\frac{1}{r^2}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Spherical wave — inverse square law", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class ThreeDWaves_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\mathbf{k}=k_x\hat{x}+k_y\hat{y}+k_z\hat{z}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Wave vector components in 3D", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p1(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        b = Text("Week 1a complete — collect key results", font_size=28, color=WHITE)
        safe_scale(b, max_width=13.0)
        b.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(b, run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p2(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\frac{\partial^2\Psi}{\partial x^2}=\frac{1}{v^2}\frac{\partial^2\Psi}{\partial t^2} \quad \Psi=f(x\pm vt)", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Wave equation and general solution", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p3(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v=f\lambda=\frac{\omega}{k} \quad k=\frac{2\pi}{\lambda} \quad \omega=2\pi f \quad T=\frac{1}{f}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Five harmonic wave relations", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p4(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"\tilde{\Psi}=Ae^{i(kx-\omega t)} \quad I\propto|\tilde{\Psi}|^2=A^2", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Complex representation and intensity", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p5(Scene):
    def construct(self):
        ...
        title.to_edge(UP, buff=0.4)
        self.add(title)
        eq = MathTex(r"v_p=\frac{\omega}{k} \quad v_g=\frac{d\omega}{dk}", font_size=40)
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("Phase velocity vs group velocity", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
...
class Week1WavesSummary_p6(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=13.0)
        eq.next_to(title, DOWN, buff=0.45)
        cap = Text("3D plane wave — general form", font_size=24, color=WAVE_COLOR)
        safe_scale(cap, max_width=13.0)
        cap.next_to(eq, DOWN, buff=0.3)
        self.play(FadeIn(VGroup(eq, cap), run_time=0.1))
        self.wait(1)
