...
class WaveIntroduction_p3(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'c=3\times10^8\,\text{m/s},\quad\text{no medium required}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("EM waves: E and B oscillate — no medium needed", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
...
class WaveIntroduction_p5(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\Psi(x,t)', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Wave function: physical quantity at position x, time t", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class WaveEquation1D_p4(Scene):
    def construct(self):
        ...
        eq = MathTex(r'\frac{\partial^2\Psi}{\partial x^2}=\frac{1}{v^2}\frac{\partial^2\Psi}{\partial t^2}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Curvature in space = acceleration in time / v squared", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class WaveEquation1D_p5(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\Psi=f(x-vt)\;\Rightarrow\;a\Psi_1+b\Psi_2\;\text{also a solution}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Linear PDE: superposition principle follows directly", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class HarmonicWaveExample_p7(Scene):
    def construct(self):
        ...
        eq = MathTex(r'E_x=E_0\sin(9.926\times10^6 z-2.977\times10^{15}t)', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Complete wave function for He-Ne laser", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class HarmonicWaveExample_p9(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\lambda=632.8\,\text{nm}\approx\frac{1}{100}\,d_\text{hair}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("632.8 nm is ~1/100th diameter of a human hair", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class SuperpositionPrinciple_p1(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\Psi=a\Psi_1+b\Psi_2\;\text{satisfies wave eq if }\Psi_1,\Psi_2\text{ do}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Superposition principle  (Bennett 1.5)", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class SuperpositionPrinciple_p6(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        cap_t = Text("Fails at high intensity in nonlinear media — second harmonic generation", font_size=30, color=WHITE)
        safe_scale(cap_t, max_width=12.5)
        t_bot = rule_top.get_bottom()[1]
        cap_t.move_to([0, (t_bot + (-3.7)) / 2, 0])
        self.play(FadeIn(cap_t, shift=UP*0.15, run_time=0.4))
...
class PhaseGroupVelocity_p1(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Phase and group velocity  (Bennett 7.6)", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class PhaseGroupVelocity_p4(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\omega=ck\;\Rightarrow\;v_p=v_g=c\quad\text{(vacuum, no dispersion)}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("In vacuum: phase and group velocity both equal c", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class PhaseGroupVelocity_p7(Scene):
    def construct(self):
        ...
        eq = MathTex(r'v_g=\frac{c}{n+\omega\,dn/d\omega}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Bennett Section 7.6 example: group velocity formula", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class ComplexRepresentation_p1(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Complex notation via Euler formula  (Bennett 1.6)", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class ComplexRepresentation_p9(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Spherical wave from point source — inverse square law", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class Week1WavesSummary_p6(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'v_p=\frac{\omega}{k}\;\text{(crests)},\quad v_g=\frac{d\omega}{dk}\;\text{(energy)}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Phase velocity vs group velocity — know the difference", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
