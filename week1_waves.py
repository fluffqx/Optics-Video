...
class Week1TitleCard(Scene):
    def construct(self):
        ...
        self.play(FadeIn(card)); self.wait(32.9); self.play(FadeOut(card))
...
class WaveIntroduction(Scene):
    def construct(self):
        ...
        pg(self, title, ["So what exactly is a wave?"], wait=2.5)
...
class WaveEquation1D(Scene):
    def construct(self):
        ...
        self.play(Write(eq)); self.wait(6.3)
        ...
        self.play(FadeIn(interp)); self.wait(15.0)
        ...
        self.play(Write(sol_title), Write(sol1)); self.wait(24.5)
        self.play(Write(sol2)); self.wait(10.2)
        ...
        self.play(FadeIn(key)); self.wait(2.0)
...
class WaveEquationProof(Scene):
    def construct(self):
        ...
        solver.finalize(); self.wait(29.0 + 8)
...
class HarmonicWave(Scene):
    def construct(self):
        ...
        pg(self, title, ["Let's go through every symbol carefully."], wait=5.8)
        ...
        self.play(FadeIn(A_row)); self.wait(13.5); self.play(FadeOut(A_row))
        ...
        self.play(FadeIn(k_eq)); self.wait(15.9); self.play(FadeOut(k_eq))
        ...
        self.play(FadeIn(w_eq)); self.wait(11.1); self.play(FadeOut(w_eq))
        ...
        self.play(FadeIn(lam_eq)); self.wait(4.9); self.play(FadeOut(lam_eq))
        ...
        self.play(FadeIn(f_eq)); self.wait(11.6); self.play(FadeOut(f_eq))
        ...
        self.play(FadeIn(v_eq)); self.wait(11.1); self.play(FadeOut(v_eq))
        ...
        self.play(FadeIn(phi_eq)); self.wait(7.8); self.play(FadeOut(phi_eq))
        ...
        solver.finalize(); self.wait(31.5 + 8 + 14)
...
class HarmonicWaveExample(Scene):
    def construct(self):
        ...
        solver.finalize(); self.wait(42.9 + 11)
        self.play(FadeOut(VGroup(title, *solver.steps)))
...
class SuperpositionPrinciple(Scene):
    def construct(self):
        ...
        self.play(Write(proof)); self.wait(15.5)
...
class PhaseGroupVelocity(Scene):
    def construct(self):
        ...
        self.play(FadeIn(vp)); self.wait(13.5); self.play(FadeOut(vp))
        ...
        self.play(FadeIn(vg)); self.wait(21.2); self.play(FadeOut(vg))
        ...
        pg(self, title, ["Example: dispersion relation omega = a k squared."], wait=9.7)
        ...
        solver.finalize(); self.wait(30.9)
        self.play(FadeOut(VGroup(title, *solver.steps)))
...
class ComplexRepresentation(Scene):
    def construct(self):
        ...
        self.wait(15.9); self.play(FadeOut(euler))
        ...
        self.play(FadeIn(cons)); self.wait(9.7); self.play(FadeOut(cons))
        ...
        block.next_to(title, DOWN, buff=0.5)
        self.play(FadeIn(block)); self.wait(21.2); self.play(FadeOut(block))
        ...
        self.play(FadeIn(I_eq)); self.wait(13.0); self.play(FadeOut(I_eq))
        ...
        self.play(FadeIn(pw_block)); self.wait(23.6); self.play(FadeOut(pw_block))
        ...
        self.play(FadeIn(sw)); self.wait(15.9)
...
class ThreeDWaves(Scene):
    def construct(self):
        ...
        self.play(Write(plane)); self.wait(21.7)
        sym = eq_table([
        ...
        self.play(FadeIn(sym)); self.wait(8.7); self.play(FadeOut(sym))
        ...
        ], wait=25.0); self.play(FadeOut(plane))
        ...
        self.play(FadeIn(sphere)); self.wait(2.0)
        pg(self, title, [
        ...
        ], wait=2.0); self.play(FadeOut(VGroup(title, sphere)))
...
class Week1WavesSummary(Scene):
    def construct(self):
        ...
        self.play(FadeIn(card)); self.wait(46.9); self.play(FadeOut(card))
