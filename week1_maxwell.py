...
class MaxwellIntro_p4(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\oint\mathbf{E}\cdot d\mathbf{A}=Q_\text{enc}/\varepsilon_0\;\Leftrightarrow\;\nabla\cdot\mathbf{E}=\rho/\varepsilon', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Integral and differential forms are equivalent  (Bennett 2.2)", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class VectorCalculusNotation_p1(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Four operators appear throughout Maxwell equations", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class EMWaveDerivation_p1(Scene):
    def construct(self):
        ...
        eq = MathTex(r'\nabla\times\mathbf{E}=-\frac{\partial\mathbf{B}}{\partial t},\quad\nabla\times\mathbf{B}=\mu_0\varepsilon_0\frac{\partial\mathbf{E}}{\partial t}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Start: Faraday and Ampere-Maxwell in vacuum", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class EMWaveDerivation_p5(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'c=\frac{1}{\sqrt{\mu_0\varepsilon_0}}=2.998\times10^8\,\text{m/s}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Maxwell 1865: computed c from EM constants — light is EM wave", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class EMWaveProperties_p5(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\mathbf{E}=E_0\hat{x}\cos(kz-\omega t),\quad\mathbf{B}=\frac{E_0}{c}\hat{y}\cos(kz-\omega t)', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("E and B oscillate in phase — same cosine factor", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class PoyntingIrradiance_p4(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'\langle\cos^2(\omega t)\rangle=\frac{1}{2}\;\Rightarrow\;I=\frac{1}{2}\varepsilon_0 c E_0^2', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Factor 1/2 from time-averaging cosine squared", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class RadiationPressure_p5(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'P_\text{rad}=\frac{I}{c}(1+R)', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Partial reflector: absorbed fraction (1-R) + reflected 2R", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class RadiationPressure_p7(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'F=\frac{I_\odot}{c}\cdot A\approx\frac{1361}{3\times10^8}\times196\approx0.9\,\text{mN}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("IKAROS 2010: 14x14 m sail, ~0.9 mN from solar radiation", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class RadiationPressure_p8(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        cap_t = Text("Optical tweezers: Nobel 2018 Ashkin — trapping cells with focused laser", font_size=30, color=WHITE)
        safe_scale(cap_t, max_width=12.5)
        t_bot = rule_top.get_bottom()[1]
        cap_t.move_to([0, (t_bot + (-3.7)) / 2, 0])
        self.play(FadeIn(cap_t, shift=UP*0.15, run_time=0.4))
...
class DispersionScene_p1(Scene):
    def construct(self):
        ...
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Dispersion: refractive index varies with frequency", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class DispersionScene_p3(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'n(\omega)=\frac{c}{v_p(\omega)},\quad v_g=\frac{c}{n+\omega\,dn/d\omega}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Phase and group velocity in dispersive medium", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
...
class DispersionScene_p4(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        cap_t = Text("Lorentz model: electrons as driven oscillators — explains normal dispersion", font_size=30, color=WHITE)
        safe_scale(cap_t, max_width=12.5)
        t_bot = rule_top.get_bottom()[1]
        cap_t.move_to([0, (t_bot + (-3.7)) / 2, 0])
        self.play(FadeIn(cap_t, shift=UP*0.15, run_time=0.4))
...
class DispersionScene_p7(Scene):
    def construct(self):
        ...
        rule_top.next_to(title, DOWN, buff=0.08)
        self.play(Write(title, run_time=0.5), FadeIn(rule_top, run_time=0.5))
        eq = MathTex(r'D=17\,\text{ps/(nm}\cdot\text{km)}\;\text{at }1550\,\text{nm}', font_size=52)
        safe_scale(eq, max_width=12.5)
        cap_t = Text("Optical fibre dispersion parameter — limits data rates", font_size=26, color=TEAL)
        safe_scale(cap_t, max_width=12.5)
        content = VGroup(eq, cap_t).arrange(DOWN, buff=0.35)
        t_bot = rule_top.get_bottom()[1]
        content.move_to([0, (t_bot + (-3.7)) / 2, 0])
